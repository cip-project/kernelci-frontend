...
require.config({
    ...
    map: {
        '*': {
            ...
            'app/view-boots-all-lab': 'app/view-boots-all-lab.2017.3.3',
            ...
            'app/view-boots-id': 'app/view-boots-id.2017.3.3',
            'app/view-boots-job-kernel': 'app/view-boots-job-kernel.2017.3.3',
            'app/view-boots-regressions': 'app/view-boots-regressions.2017.3.3',
            'app/view-build-compare': 'app/view-build-compare.2017.3.3',
            'app/view-builds-all': 'app/view-builds-all.2017.3.3',
            'app/view-builds-id': 'app/view-builds-id.2017.3.3',
            'app/view-builds-job-branch-kernel': 'app/view-builds-job-branch-kernel.2017.3.3',
            'app/view-builds-job-kernel': 'app/view-builds-job-kernel.2017.3.3',
            'app/view-builds-job-kernel-defconfig': 'app/view-builds-job-kernel-defconfig.2017.3.3',
            'app/view-builds-job-kernel-defconfig-logs': 'app/view-builds-job-kernel-defconfig-logs.2017.3.3',
            ...
            'app/view-job-compare': 'app/view-job-compare.2017.3.3',
            'app/view-jobs-all': 'app/view-jobs-all.2017.3.3',
            'app/view-jobs-job': 'app/view-jobs-job.2017.3.3',
            'app/view-jobs-job-branch': 'app/view-jobs-job-branch.2017.3.3',
            ...
            'app/view-socs-soc-job-kernel': 'app/view-socs-soc-job-kernel.2017.3.3',
